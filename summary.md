...
- Module boundaries:
  ...
  - `geocode`: cache-first geocoding with Geocodio fallback (`geocode_batch_hybrid`)
  - `geocode_cache`: DuckDB-backed `geocode_cache` table helpers
  - `geocodio`: Geocodio REST API batch client
